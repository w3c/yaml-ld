...
as developed by the [JSON for Linking Data Community Group](https://www.w3.org/community/json-ld/). The latest Editor's Draft of the Note can be [read directly](https://w3c.github.io/yaml-ld/spec/).
